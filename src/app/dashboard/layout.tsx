  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F9FAFB]">
      ...
      <div className="relative flex flex-1 min-h-0 items-stretch">
        ...
        <aside
          className={`fixed left-0 top-16 z-50 h-[calc(100dvh-4rem)] w-[min(280px,88vw)] -translate-x-full overflow-y-auto border-r border-slate-200/90 bg-[#F3F4F6] shadow-xl transition-transform duration-200 lg:static lg:top-auto lg:z-0 lg:h-auto lg:min-h-[calc(100dvh-4rem)] lg:w-[260px] lg:shrink-0 lg:translate-x-0 lg:shadow-none ${
